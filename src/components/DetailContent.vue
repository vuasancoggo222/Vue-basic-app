...
<section class="text-gray-700 body-font overflow-hidden bg-white">
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-10 lg:mt-0">
        <h2 class="text-sm title-font text-gray-500 tracking-widest mb-5 text-[18px]">{{category}}</h2>
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{{name}}</h1>
        <div class="flex mb-4">
          <span class="flex items-center mt-3">
            <span class="text-gray-600 ml-1">{{date}}</span>
          </span>
        ...
        <div class="flex">
          <span class="title-font font-medium text-2xl text-gray-900">{{price}} đ</span>
        ...
        <div>
            <span class="title-font font-medium text-2xl text-gray-900 text-[18px]">Trạng thái: {{status ? 'Còn Hàng' : 'Hết Hàng'}}</span>
        </div>
      </div>
    </div>
  </div>
